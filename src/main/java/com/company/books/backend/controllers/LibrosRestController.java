...
public class LibrosRestController {
	...
	public ResponseEntity<LibrosResponseRest>editarLibro(@RequestBody Libro libro,@PathVariable Long id){
		ResponseEntity<LibrosResponseRest> response = service.editarLibro(libro, id);
		return response;
	}
	
	@DeleteMapping("/libros/{id}")
	public ResponseEntity<LibrosResponseRest>eliminarLibro(@PathVariable Long id){
		ResponseEntity<LibrosResponseRest> response = service.eliminarLibro(id);
		return response;
	}
}
